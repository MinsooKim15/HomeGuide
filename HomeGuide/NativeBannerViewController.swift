...
final private class NativeBannerViewControllerRepresntable: UIViewControllerRepresentable{
    func makeUIViewController(context: Context) -> UIViewController {
        let view = UIView()
        
        print("NativeAd Start")
        let viewController = NativeBannerViewController()
...
class NativeBannerViewController: UIViewController  {
...
extension NativeBannerViewController: GADVideoControllerDelegate {
...
extension NativeBannerViewController: GADAdLoaderDelegate {
...
extension NativeBannerViewController: GADUnifiedNativeAdLoaderDelegate {
...
extension NativeBannerViewController: GADUnifiedNativeAdDelegate {
...
struct NativeAd:View{
    var body: some View{
        HStack{
            Spacer()
            NativeBannerViewControllerRepresntable().frame(width: 320, height: 50, alignment: .center)
            Spacer()
        }
    }
}
